...
var editCompletedTodo = require("./routes/editCompletedTodo");
var editContentTodo = require("./routes/editContentTodo");
app.use(createTodo);
app.use(removeTodo);
app.use(allTodo);
...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_1["default"].connect("mongodb+srv://antonmerkotun:1996178dD@data.2j7wv.mongodb.net/data?retryWrites=true&w=majority")];
            case 1:
                _a.sent();
